		...
		<div class="main-section-categ">
			<div class="main-section-container">
				<div class="heading-title text-center">
					...
					<p>oe sus datos y confirme su reserva</p>
				</div>
					...
					<form id="contactForm" method="post" action="banquet-1.php">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									<select class="custom-select d-block form-control" id="n-reason" required data-error="Please Select No. of Slots" name="menu">
										...
										<option value="5.00">Plan - 1: $5.00 per plate</option>
										<option value="7.00">Plan - 2: $7.00 per plate</option>
										<option value="9.00">Plan - 3: $9.00 per plate</option>
										<option value="11.00">Plan - 4: $11.00 per plate</option>
										<option value="13.00">Plan - 5: $13.00 per plate</option>
									</select>
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									<input type="number" onchange="calc()" class="form-control" id="b-name" name="b-no" min="50" max="1000" placeholder="Ingrese el numero de personas" required data-error="Please Enter Number">
									<div class="help-block with-errors"></div>
								</div>
							</div>
							<script>
